...
import { ShockAbsorber, CushionManager, AbsorptionEngine, PluginEcosystem } from '../../core';
...
describe('ShockAbsorber (InterceptorManager)', () => {
  ...
  beforeEach(() => {
    ...
    shockAbsorber = new ShockAbsorber(cushionManager, absorptionEngine, pluginEcosystem);
  ...
  describe('Activation and Deactivation', () => {
    ...
    it('should restore original fetch when deactivated', () => {
      ...
      shockAbsorber.activate();
      expect(global.fetch).not.toBe(interceptedFetch);
